  ...
  def __init__(self):
    ...
    for playerInd in range(len(playersTerritories)):
      ...
      for territoryInd in playersTerritories[playerInd]:
        territories[territoryInd].colonize(ownerColor)
    self.gameMap = GameMap(territories, regions)
