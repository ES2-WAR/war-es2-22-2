...
class Game:
  def __init__(self):
    ...
    testTerritories: list[Territory] = [Territory('preto',[1,3,29],0,'Alaska',0,99, 139),Territory('branco',[0,3,4,2],0,'Mackenzie',1,245, 127),Territory('vermelho',[1,5,13],0,'Groenlandia',2,422, 98),Territory('vermelho',[0,1,4,6],0,'Vancouver',3,187, 200),Territory('branco',[1,3,5,7],0,'Ottwa',4,285, 221),Territory('branco',[4,7,2],0,'Labrador',5,335, 219),Territory('branco',[3,7,8,4],0,'California',6,193, 285),Territory('preto',[4,5,6,8],0,'Nova York',7,285, 303),Territory('verde',[6,7,9],0,'Mexico',8,199, 362),Territory('branco',[8,10,11],1,'Colombia',9,278, 456),Territory('vermelho',[9,11,12],1,'Bolivia',10,316, 549),Territory('branco',[9,10,12,20],1,'Brasil',11,389, 535),Territory('branco',[10,11],1,'Argentina',12,317, 634),Territory('branco',[2,16,14],2,'Islandia',13,522, 182),Territory('preto',[16,15,13,17],2,'Suecia',14,600, 198),Territory('branco',[14,17,19,26,32,35],2,'Moscou',15,709, 242),Territory('branco',[13,17,18,14],2,'Inglaterra',16,500, 237),Territory('branco',[15,16,18,19,14],2,'Alemanha',17,602, 280),Territory('preto',[16,17,19,20,21],2,'Portugal',18,511, 378),Territory('branco',[17,18,21,35,15],2,'Polonia',19,631, 339),Territory('branco',[18,11,23,22,21],3,'Argelia',20,559, 499),Territory('branco',[18,20,22,35,19],3,'Egito',21,668, 452),Territory('preto',[21,20,23,25],3,'Sudão',22,707, 535),Territory('branco',[20,22,24],3,'Congo',23,654, 590),Territory('branco',[23,22,25],3,'Africa do Sul',24,667, 688),Territory('verde',[22,24],3,'Madagascar',25,760, 690),Territory('branco',[15,27,31,33,32],4,'Omsk',26,826, 214),Territory('verde',[26,28,30,31],4,'Dudinka',27,884, 145),Territory('branco',[27,30,29],4,'Siberia',28,970, 123),Territory('branco',[28,30,33,0],4,'Vladivostok',29,1060, 130),Territory('branco',[28,27,31,33,29],4,'Tchita',30,953, 219),Territory('preto',[30,27,26,33,34],4,'Mongolia',31,972, 291),Territory('vermelho',[26,15,35,36,33],4,'Aral',32,810, 305),Territory('preto',[31,26,32,36,37,34],4,'China',33,960, 359),Territory('branco',[29,31],4,'Japao',34,1079, 311),Territory('branco',[15,19,21,36,32],4,'Oriente Medio',35,735, 408),Territory('branco',[32,35,33,37,38],4,'India',36,878, 417),Territory('verde',[33,36,39],4,'Vietna',37,978, 455),Territory('vermelho',[36,41],5,'Sumatra',38,990, 574),Territory('preto',[37,40,41],5,'Nova Guiné',39,1099, 551),Territory('branco',[39,41],5,'Nova Zelândia',40,1138, 676),Territory('vermelho',[38,39,40],5,'Australia',41,1036, 691)]
